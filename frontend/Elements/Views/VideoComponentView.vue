        ...
        <div class="container"  v-if="rounds[0]">
            ...
            <div class="menu">
                ...
                <div class="button" v-for="(round,index) in rounds"
                     @click="setRanking(index+1)"
                     :key="index">{{index+1}}</div>
            </div>
            <template v-if="clickedRank===0">
                <GlobalRanking
                :users="users"
                :rounds="rounds"
                ></GlobalRanking>
            ...
            <template v-else>
                <Ranking v-if="rounds[clickedRank-1].round.length"
                         :users="users"
                         :round="rounds[clickedRank-1].round"
                ></Ranking>
            </template>
